...
func main() {
	...
	fmt.Println("Menghapus data lama (optional)...")
	db.Exec("TRUNCATE TABLE blogs RESTART IDENTITY CASCADE;")
	db.Exec("TRUNCATE TABLE faqs RESTART IDENTITY CASCADE;")
	db.Exec("TRUNCATE TABLE testimonials RESTART IDENTITY CASCADE;")

	fmt.Println("Menyisipkan 5 Testimonial...")
	...
	fmt.Println("Menyisipkan 10 Blog...")
	blogs := []Models.Blog{
	...
	fmt.Println("Selesai melakukan seeding!")
}
